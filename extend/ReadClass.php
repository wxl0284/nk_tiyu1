...
class ReadClass
{
    ...
    public static function readFile($path, $parents = false)
    {
        ...
        $class = '\app'.str_replace([realpath(\think\facade\Env::get('app_path')), ".php", DIRECTORY_SEPARATOR], [config("app_namespace"), "", "\\"], realpath($path));
...
//            $class_name = explode("\\", $class);
            ...
            return ["class" => $class, "class_name" => $title, "method" => $method];
        }
        return false;
    }

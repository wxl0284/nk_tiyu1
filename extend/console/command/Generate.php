...
EOF
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        if (strpos($config, ':')) {
            ...
            $controller = str_replace('.', DIRECTORY_SEPARATOR, Loader::parseName(str_replace(['/', DIRECTORY_SEPARATOR, ':'], '.', $controller)));
            $configFile = \think\facade\Env::get('app_path') . strtolower($module) . DIRECTORY_SEPARATOR . 'view' . DIRECTORY_SEPARATOR . $controller . DIRECTORY_SEPARATOR . $file;
        } else {

...
class Pub
{
    ...
    {
        if (null === $this->view) {
            $this->view = View::instance(Config::pull('template'), config('template.tpl_replace_string'));
        }
    ...
    public function checkLogin()
    {
        if ($this->request->isAjax() && $this->request->isPost()) {
            ...
            if(!captcha_check($data['captcha'])){
                return ajax_return_adv_error('验证码错误!');
            }
    ...
    public function password()
    {
        ...
        if ($this->request->isPost()) {
            ...
            // 写入新密码
            if (false === \think\facade\App::model('AdminUser')->updatePassword(UID, $data['password'])) {
